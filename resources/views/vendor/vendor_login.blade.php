...
<body class="bg-login">
			...
			<div class="container-fluid">
              ...
              <div class="form-body">
                ...
                <div class="col-12">
                    ...
                    <input type="email" id="email" name ="email" class="form-control" id="inputEmailAddress" placeholder="Email Address">
                </div>
                <div class="col-12">
	...
	<!--app JS-->
	<script src="{{asset('adminbackend/assets/js/app.js')}}"></script>4
