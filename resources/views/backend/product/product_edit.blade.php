...
<div class="row">
    ...
    <div class=" form-group mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="product_tags" class="form-control visually-hidden" data-role="tagsinput" value="{{ $products->tags }}">
          </div>
        ...
        <div  class="form-group mb-3">
            <label for="inputProductTitle" class="form-label">Short Description</label>
                    <textarea name="short_descp" id="inputProductDescription" class="form-control" rows="3">{{ $products->short_descp }}</textarea>

        </div>
        <div class="mb-3">
            <label for="inputProductTitle" class="form-label">Long Description</label>
                    <textarea name="long_descp" id="inputProductDescription" class="form-control" rows="5">{{ $products->long_descp }}</textarea>
    ...
    <div class="border border-3 p-4 rounded">
        ...
        <div class="form-group col-md-6">
            ...
            <select name ="brand_id"class="form-select" id="inputProductType">
                ...
                <!--ene foreachiig sain haraj oilgo   ene codeiin tailbar ni brand id ni $products aar damjuulaad brand_id (db table dotorh) taarch baiwal selectediig songono taarahgui bol hooson baina-->
...
<div class="col-12">
    ...
    <div class="form-check">
            ...
            <div class="col-12">
                <div class="d-grid">
                    <button type="submit" class="btn btn-info" value="Save">Save Product</button>
                </div>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                product_thambnail: {
                    required : 'Please Enter Thambnail ',
                },
                multi_img: {
                    required : 'Please Select Product Name',
                },
                selling_price: {
                    required : 'Please Enter selling price Name',
                },
                discount_price: {
                    required : 'Please Enter discount price Name',
                },
                product_code: {
