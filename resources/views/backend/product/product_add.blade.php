...
<div class="row">
    ...
    <div class=" form-group mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="product_color" class="form-control visually-hidden" data-role="tagsinput" value="Red, Blue, White">
          </div>

        <div  class="form-group mb-3">
            <label for="inputProductTitle" class="form-label">Short Description</label>
                    <textarea name="short_descp" id="inputProductDescription" class="form-control" rows="3"></textarea>

        </div>
        <div class="mb-3">
            <label for="inputProductTitle" class="form-label">Long Description</label>
                    <textarea name="long_descp" id="inputProductDescription" class="form-control" rows="5"></textarea>
