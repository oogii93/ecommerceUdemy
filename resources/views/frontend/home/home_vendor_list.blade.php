...
@php
    ...
    //duriin $vendors gesen huwisagch zarlaad User modeloor damjuulan User database-ees datagaa duudaj baina
    //daraaa ni blade deer door $vendor huwisagchaa duudaad yamaar baigaaagaa zaaj ogno . jisheelbel haana haana yaj duudahiig
                                  ...
                                  <div>
                                      ...
                                      <div class="product-rate-cover">
                                        ...
                                        @endphp
                                         ...
                                         <span class="font-small total-product">{{ count($product) }}</span>
                                      </div>
                                  </div>
