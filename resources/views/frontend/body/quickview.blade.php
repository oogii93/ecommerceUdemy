<div class="modal fade custom-modal" id="quickViewModal" tabindex="-1" aria-labelledby="quickViewModalLabel" aria-hidden="true">
 ...
 <h5 class="title-detail"><a href="" id="pname" class="text-heading"></a></h5>
                           <br>
<!-- Id gaar ni js eer duduah gej baina -->
                ...
                <span class="save-price font-md color3 ml-15" id="oldprice">$</span>
                        ...
                        <div class="detail-extralink mb-30">
                            ...
                            <div class="product-extra-link2">
                                ...
                                <button type="submit" class="button button-add-to-cart"><i class="fi-rs-shopping-cart" onclick="addToCart()"></i>Add to cart</button>
                            </div>
                        </div>
