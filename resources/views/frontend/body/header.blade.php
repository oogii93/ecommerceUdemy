<header class="header-area header-style-1 header-height-2">
    ...
    <div class="header-middle header-middle-ptb-1 d-none d-lg-block">
        ...
        <div class="header-action-icon-2">
          ...
          <!--herwee user newtersen bol doorh selection garch irne vgvui bol-->
 @auth
...
<span class="lable ml-0" style="margin-left:2pxl; margin-right:2px">|</span>
...
<a href="{{ route('register') }}"><span class="lable ml-0">Register</span></a>
    ...
    <div class="header-bottom header-bottom-bg-color sticky-bar">
        ...
        //data base deerh category table-ees bvgdiig ni end duudaj awana
            ...
            $categories=App\Models\Category::orderBy('category_name','ASC')->limit(5)->get();//zowhoon 5 data gargaj baina
        @endphp
                    ...
                    //data base deerh category table-ees bvgdiig ni end duudaj awana
                        ...
                        $subcategories=App\Models\SubCategory::where('category_id',$category->id)->orderBy('subcategory_name','ASC')->get();//zowhoon 5 data gargaj baina
                    @endphp
